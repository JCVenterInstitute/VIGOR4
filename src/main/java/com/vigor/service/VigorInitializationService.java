...
public class VigorInitializationService {
	...
	@Autowired
    private ReferenceProteinGenerationService  referenceProteinGenerationService;
	...
	public void initializeVigor(CommandLine inputs) {
		try {
            ...
            VigorForm form = loadVigorParameters(inputs);
            ...
            Stream<NucleotideFastaRecord> records = dataStore.records();
   		    ...
   		    while(i.hasNext()){
                ...
                form.setVirusGenome ( genome );
                referenceProteinGenerationService.chooseAlignmentEvidence(form);
	 ...
	 */
	public VigorForm loadVigorParameters(CommandLine inputs) {
