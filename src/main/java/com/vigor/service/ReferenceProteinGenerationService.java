...
import org.jcvi.jillion.experimental.align.blast.XmlFileBlastParser;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.core.io.ResourceLoader;
import org.springframework.stereotype.Service;

import com.vigor.blast.BlastVistorImpl;
import com.vigor.component.VirusGenome;
import com.vigor.forms.VigorForm;


@Service
public class ReferenceProteinGenerationService {

	private static final Logger LOGGER = LogManager.getLogger(ReferenceProteinGenerationService.class);
	...
	public void chooseAlignmentEvidence(VigorForm form, VirusGenome virusGenome) {
		System.out.println("Inside choose AlignmentEvidence");
   	//	blastVirusGenome(virusGenome, form);
		//if(form.getAlignmentEvidence().getReference_db() )
